...
* The original package name 'com.LibrarayManagement.cloud-config-server' is invalid and this project uses 'com.LibrarayManagement.cloudconfigserver' instead.
